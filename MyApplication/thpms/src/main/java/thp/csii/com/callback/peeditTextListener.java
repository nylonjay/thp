 ...
 */
public class peeditTextListener implements TextWatcher{
    Handler hand;
    ...
    public peeditTextListener(EditText mEditTextMsg, Handler handler) {
    ...
    public void onTextChanged(CharSequence s, int start, int before, int count) {
        ...
        if ((charMaxNum-s.length())==0||s.length()==0){
