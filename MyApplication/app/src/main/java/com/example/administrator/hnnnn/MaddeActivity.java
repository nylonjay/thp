...
public class MaddeActivity extends AppCompatActivity implements PayOrderListener,QryAmountListner{
    ...
    private String Oid="c14004525214";
    private Double Amount=1.00;
    private String Mid="00195";
    private String consumeSign="4875dbbfd3987427b1dfb5d4c28760e2e5a50f9a";// 订单消费这两个都传
    ...
    private Button btn_qr,btn_getqr;
    ...
    private String QRcode="type=TH_PAY&otid=600";
