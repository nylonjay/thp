...
public class MaddeActivity extends AppCompatActivity implements PayOrderListener,QryAmountListner{
    ...
    private String Accno="7000290210000054012";//7800100000002282林再雄的账号 //7000290210000032307李锐的账号
    ...
    private String Oid="m1514823ttt71899426";
    ...
    private String userSign="a811c7ed7e37d367b1946b859e7a17b20b8b6543";//进入首页传
    ...
    private String userAccno="7000290210000054012";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // initData();
        Constant.setSERVERHOST("http://192.168.208.126:8080");
