...
public class MaddeActivity extends AppCompatActivity implements PayOrderListener,QryAmountListner{
    ...
    private String Accno="7000290210000001153";//7800100000002282林再雄的账号 //7000290210000032307李锐的账号
    ...
    private String Oid="njsjd54236";
    private Double Amount=10.00;
    private String Mid="00195";
    private String consumeSign="5e552d27a1c1922f591967b8a9260a34f9031fee";// 订单消费这两个都传
    private String userSign="dc5481f0d059e4201e60d11d41b6e7264b9854e4";//进入首页传
    ...
    private String userAccno="7000290210000001153";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // initData();
        Constant.setSERVERHOST("http://192.168.208.148:8080");
...
//                TianHongPayMentUtil.tianHongPayMentUtil.onMainActivityFinished=mOnMainfinished;
    ...
    public void PayFailed(String msg) {
        ToastUtil.shortNToast(MaddeActivity.this,"回调==="+msg);
    }
